...
grant execute on function public.delete_own_account_data(uuid) to service_role;-- Authoritative account-data cleanup. Supabase Auth deletion is deliberately
-- performed by the API only after this transaction commits successfully.
